...
After consolidation, `shared/docs/CI-TOOLCHAIN.md` and `java-microservice-scaffold/docs/unit-testing.md` SHALL become stubs redirecting to `docs/QUALITY-GATES.md` with section anchors; unique content (e.g., Sonar Connected Mode details) MAY remain linked from QUALITY-GATES rather than duplicated.
